...
public class ProductExceptionHandler {
    ...
    public ResponseEntity<ErrorResponses> handleProductNotFoundException() {
        ...
        return new ResponseEntity<>(new ErrorResponses(AllConstants.OPERATION_FAILED, httpStatus, AllConstants.ERROR_PRODUCT_NOT_FOUND), httpStatus);
    }

    @ExceptionHandler(value = {UnexpectedTypeException.class})
    public ResponseEntity<ErrorResponses> handleUnexpectedTypeException() {
        HttpStatus httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
        return new ResponseEntity<>(new ErrorResponses(AllConstants.OPERATION_FAILED, httpStatus, AllConstants.ERROR_INVALID_HTTP_REQUEST), httpStatus);
    }
    ...
    public ResponseEntity<ErrorResponses> handleOtherExceptions() {
        HttpStatus httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
        return new ResponseEntity<>(new ErrorResponses(AllConstants.OPERATION_FAILED, httpStatus, AllConstants.UNEXPECTED_ERROR), httpStatus);
    }
}
